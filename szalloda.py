...
class EgyagyasSzoba(Szoba):
    def __init__(self, szobaszam):
        super().__init__(szobaszam, 10000)  # 10000 Ft / éj az ár

class KetagyasSzoba(Szoba):
    def __init__(self, szobaszam):
        super().__init__(szobaszam, 15000)  # például 15000 Ft / éj az ár
...
def main():
    ...
    szalloda.foglalas_hozzaadasa(101, "2024-05-02")
    szalloda.foglalas_hozzaadasa(102, "2024-05-03")
    szalloda.foglalas_hozzaadasa(103, "2024-05-04")
    szalloda.foglalas_hozzaadasa(101, "2024-05-05")
    szalloda.foglalas_hozzaadasa(102, "2024-05-06")
